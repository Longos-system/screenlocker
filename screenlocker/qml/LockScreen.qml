...
//            anchors.topMargin: LongUI.Units.largeSpacing
    ...
    Item {
        ...
        width: 280 + LongUI.Units.largeSpacing * 3
        height: _mainLayout.implicitHeight + LongUI.Units.largeSpacing * 4

        Layout.alignment: Qt.AlignHCenter

        Rectangle {
            anchors.fill: parent
            radius: LongUI.Theme.bigRadius + 2
            color: LongUI.Theme.darkMode ? "#424242" : "white"
            opacity: 0.5
        }
        ...
        ColumnLayout {
            ...
            TextField {
                ...
                rightPadding: 36 + LongUI.Units.largeSpacing //LongUI.Units.largeSpacing
                ...
                background: Rectangle {
                    color: LongUI.Theme.darkMode ? "#B6B6B6" : "white"
    ...
    Item {
        ...
        anchors.bottomMargin: root.height * 0.05 //LongUI.Units.largeSpacing
        anchors.horizontalCenter: parent.horizontalCenter
